...
# RUN cd /var/lib/dpkg \
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/1.1.1/couchbase-sync-gateway-enterprise_1.1.1-10_x86_64.deb \
 && dpkg -i couchbase-sync-gateway-enterprise_1.1.1-10_x86_64.deb
