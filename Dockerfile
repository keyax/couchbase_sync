...
RUN wget -q http://packages.couchbase.com/releases/couchbase-sync-gateway/1.3.1/couchbase-sync-gateway-community_1.3.1-16_x86_64.deb -O package.deb && \
   dpkg -i sync-gateway package.deb && \
   rm package.deb
